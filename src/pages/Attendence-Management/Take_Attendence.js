                            ...
                            <ModalBody>
                              <FormGroup>
                                ...
                                >
                                  ...
                                  <option value="Reason 1">Reason 2</option>
                                  <option value="Reason 1">Reason 3</option>
                                  <option value="Reason 1">Reason 4</option>
                                  <option value="Reason 1">Reason 5</option>
                                  <option value="Others">Others</option>
                                </Input>
                                {msg==="Others" && <Input value={otherMessage}
                                onChange={(e) => setOtherMessage(e.target.value)} type="text" className="mt-3" placeholder="Write a reason"/>}
                              </FormGroup>
                            </ModalBody>
                            <ModalFooter>
                              <Button
