      ...
      <Card>
        <div>
            ...
            <tbody>
              {rows.map((row, index) => (
                <tr key={index}>
                  ...
                  <td>{row.assigned_to === "" ? "Not Assigned" : row.assigned_to}</td>
          ...
          <Modal isOpen={modal} toggle={toggleModal}>
            <ModalHeader  toggle={toggleModal}>Issue Type: {rowData?.issue_type}</ModalHeader>
            <ModalBody>
              {rowData && (
                <div>
                
                  <p><strong>Date:</strong> {moment(rowData.created_at).format('YYYY-MM-DD HH:mm:ss')}</p>
                  <p><strong>Assign to:</strong> {rowData.assigned_to === "" ? "Not Assigned" : rowData.assigned_to}</p>
                  <p><strong>Stage:</strong> {rowData.status}</p>
                  <p><strong>Details:</strong> </p>
                  {rowData.issue_type==="Complaint"? rowData.details : <>
                <p> <strong>From: </strong>{rowData.details.leave_from}</p>
                <p><strong>To:</strong> {rowData.details.leave_to}</p>
                <p><strong>Reason:</strong> {rowData.details.reason}</p>
                  </>}
